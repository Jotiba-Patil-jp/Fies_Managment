    ...
    <div class="site-wrapper-inner">
      ...
      <div class="cover-container">
        ...
        <div class="masthead clearfix">
          <div class="inner">
            <h3 class="masthead-brand">DMS's Mandal's <br>Collage of Coputer Application's</h3>
            <nav>
              <ul class="nav masthead-nav" style="border-bottom: 0px;">
