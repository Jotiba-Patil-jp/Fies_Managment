    ...
    <div class="container">
      ...
      ?>
        <div class="col-md-7 col-md-offset-5">
          <td><a href="app_comp.php?app_comp=<?php echo $get_id; ?> & view_sub=<?php echo $get_id1; ?> & app_con=<?php echo $get_email; ?> & app_sta=<?php echo "Approve"; ?> " class="btn btn-lg btn-default">Approve</a></td>
        </div>

      <?php } else { ?>
        <div class="col-md-7 col-md-offset-5">
          <td><a href="app_comp.php?app_comp=<?php echo $get_id; ?> & view_sub=<?php echo $get_id1; ?> & app_con=<?php echo $get_email; ?> & app_sta=<?php echo "Pending"; ?> " class="btn btn-lg btn-default">Pending </a></td>
        </div>
