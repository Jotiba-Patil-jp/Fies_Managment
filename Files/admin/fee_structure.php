                        ...
                        <div class="flex flex-col gap-5 min-h-[calc(100vh-188px)] sm:min-h-[calc(100vh-204px)]">
                            ...
                            <div class="grid grid-cols-1 gap-5">
                                <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                    <h2 class="text-base font-semibold mb-4">MBA Fee Structure</h2>
                                ...
                                <div class="flex justify-center">
                                    <a href="ugfee_edit.php" class="bg-success text-white font-bold text-xs py-2 px-3 rounded-full" style="cursor: pointer;">UPDATE</a>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 gap-5">
                                <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                    <h2 class="text-base font-semibold mb-4">MCA Fee Structure</h2>
                                    <div class="overflow-auto">
                                        <table class="min-w-[640px] w-full product-table">
                                            <thead>
                                                <tr class="text-left">
                                ...
                                <div class="flex justify-center">
                                    <a href="phdfee_edit.php" class="bg-success text-white font-bold text-xs py-2 px-3 rounded-full" style="cursor: pointer;">UPDATE</a>
                                </div>
                            ...
                            <div class="grid grid-cols-1 gap-5">
                                <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                                    <h2 class="text-base font-semibold mb-4">M.COM Fee Structure</h2>
                                    <div class="overflow-auto">
                                        <table class="min-w-[640px] w-full product-table">
                                            <thead>
                                                <tr class="text-left">
                            ...
                            <div class="flex justify-center">
                                <a href="mtfee_edit.php" class="bg-success text-white font-bold text-xs py-2 px-3 rounded-full" style="cursor: pointer;">UPDATE</a>
                            </div>
                        </div>
                        <!-- End All Card -->
