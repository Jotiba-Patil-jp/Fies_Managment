    ...
    <div class="bg-white dark:bg-dark text-dark dark:text-white">
      ...
      <div class="main-container flex mx-auto">
        ...
        <div class="main-content flex-1">
          <?php require_once('includes/topBarStudent.php'); ?>
            ...
            <div class="flex flex-col gap-5 min-h-[calc(100vh-188px)] sm:min-h-[calc(100vh-204px)]">
              <div class="grid grid-cols-1 gap-4 flex-1" x-data="email">
                <div class="flex gap-5 items-stretch relative overflow-hidden" x-data="{activeTab:'profile'}">
                  ...
                  <div x-show="activeTab === 'profile'" class="flex flex-row items-start gap-4 relative w-full" style="">
                    <div class="w-full flex flex-col flex-1 rounded-lg overflow-y-auto h-[calc(100vh-188px)] sm:h-[calc(100vh-204px)]">
                      ...
                      <div class="mt-[30px]">
                        <form class="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
                          <input type="text" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Student ID" value="<?php echo $stu_id ?>" readonly="">
                          <input type="text" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Student Name" value="<?php echo $stu_name ?>" readonly="">
                          <div class="flex items-stretch gap-5">
                            <select class="form-select !w-20 h-14 rounded-[10px]">
                              <option value="5">+91</option>
                            </select>
                            <input type="email" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Student Email" value="<?php echo $stu_email ?>" readonly="">
                          </div>
                          <input type="text" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Category" value="<?php echo $stu_cat1  ?>" readonly="">
                          <input type="text" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Degree" value="<?php echo $stu_cat2 ?>" readonly="">
                          <input type="text" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Academic Year" value="<?php echo $year ?>" readonly="">
                          <input type="text" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Admission Year" value="<?php echo $stu_year ?>" readonly="">
                          <input type="text" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Address" value="<?php echo $stu_addr ?>" readonly="">
                          <input type="text" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Contact Information" value="<?php echo  $stu_contect ?>" readonly="">
                          <input type="text" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Semester Fees" value="<?php echo $sem_fee ?>" readonly="">
                          <input type="text" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Mess Fees" value="<?php echo $mess_fee ?>" readonly="">
                          <input type="text" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Other Fees" value="<?php echo $other_fee ?>" readonly="">
                        </form>
                      </div>
                    </div>
                  </div>
                  <div x-show="activeTab === 'notification'" x-data="{selectedMail: false}" class="flex flex-row items-start gap-4 relative w-full h-[calc(100vh-188px)] sm:h-[calc(100vh-204px)]" style="display: none;">
                    <div class="w-full flex flex-col flex-1 rounded-lg overflow-y-auto h-[calc(100vh-188px)] sm:h-[calc(100vh-204px)]">
                      <div class="flex items-center gap-5">
                        <button type="button" class="xl:hidden hover:text-primary duration-300" @click="isShowChatMenu = !isShowChatMenu">
                          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div x-show="activeTab === 'plan'" x-data="{selectedMail: false}" class="flex flex-row items-start gap-4 relative w-full h-[calc(100vh-188px)] sm:h-[calc(100vh-204px)]" style="display: none;">
                    <div class="w-full flex flex-col flex-1 rounded-lg overflow-y-auto h-[calc(100vh-188px)] sm:h-[calc(100vh-204px)]">
                      <div class="flex items-center gap-5">
                        <button type="button" class="xl:hidden hover:text-primary duration-300" @click="isShowChatMenu = !isShowChatMenu">
                          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div class="mt-[30px]" x-data="{ isYearly: false }">
                                ...
                                <div class="flex justify-center items-center">
                                  ...
                                  <div class="mx-4">
                                    <label class="relative inline-block w-[42px] h-[22px] rounded-full">
                                      <input type="checkbox" x-model="isYearly" class="peer opacity-0 w-0 h-0">
                                      <span class="absolute cursor-pointer top-0 left-0 right-0 bottom-0 bg-gray/20 dark:bg-gray/40 rounded-full duration-300 before:content-[''] before:absolute before:w-3.5 before:h-3.5 before:top-1/2 before:-translate-y-1/2 before:left-[3px] before:rounded-full before:bg-white before:duration-300 peer-checked:before:translate-x-[22px] peer-checked:bg-success"></span>
                                    </label>
                                  </div>
                                  <span class="text-sm/[24px] font-semibold">
                                    Yearly
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mt-[30px]">
                          <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                            ...
                            <div class="mt-10">
                              <a href="javascript:;" class="bg-gray/10 block text-center rounded-full py-5 px-3 uppercase text-xs font-extrabold tracking-[3px] hover:bg-dark hover:text-white dark:hover:bg-white dark:hover:text-dark duration-300">Get Started</a>
                            </div>
                          </div>
                          <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                            <div class="flex items-center gap-5">
                              <svg width="40" height="40" class="text-pink" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_614_8877)">
                                  <path opacity="0.3" d="M33.2485 28.5688L36.8879 24.9248L35.2315 23.2684L32.4787 26.0212L31.5828 23.0538L35.0915 19.5451L33.4352 17.8887L30.8177 20.5296L30.0805 18.0987L22.2092 25.6293L31.2096 40L35.4088 35.8008L33.2485 28.5688Z" fill="currentColor"></path>
                                  <path opacity="0.3" d="M21.9293 9.91484L19.4984 9.18231L22.1206 6.56479L20.4642 4.90376L16.9462 8.39846L13.9974 7.52128L16.7456 4.76845L15.0706 3.11209L11.4312 6.75142L4.19923 4.57716L0 8.77639L14.3707 17.7861L21.9293 9.91484Z" fill="currentColor"></path>
                            ...
                            <p class="mt-5 text-gray max-w-[266px] text-sm/7">Contrary to popular belief, Lorem Ipsum not simply random text.</p>
                            <p class="font-semibold mt-10"><span class="text-[44px]">$<span x-text="isYearly ? '399' : '49'">49</span></span><span class="text-gray" x-text="isYearly ? '/yr' : '/mo'">/mo</span></p>
                            <div class="h-[2px] bg-gray/10 dark my-[30px]"></div>
                            <div class="space-y-5">
                              <p class="flex items-center gap-2.5 text-sm">
                                <span class="text-success">
                            ...
                            <div class="mt-10">
                              <a href="javascript:;" class="block text-center rounded-full py-5 px-3 uppercase text-xs font-extrabold tracking-[3px] bg-dark text-white dark:bg-white dark:text-dark duration-300">Get Started</a>
                            </div>
                          </div>
                          <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
                            <div class="flex items-center gap-5">
                            ...
                            <p class="mt-5 text-gray max-w-[266px] text-sm/7">Contrary to popular belief, Lorem Ipsum not simply random text.</p>
                            <p class="font-semibold mt-10"><span class="text-[44px]">$<span x-text="isYearly ? '899' : '99'">99</span></span><span class="text-gray" x-text="isYearly ? '/yr' : '/mo'">/mo</span></p>
                            <div class="h-[2px] bg-gray/10 dark my-[30px]"></div>
                            <div class="space-y-5">
                              <p class="flex items-center gap-2.5 text-sm">
                                <span class="text-success">
                  ...
                  <div x-show="activeTab === 'pw'" x-data="{selectedMail: false}" class="flex flex-row items-start gap-4 relative w-full h-[calc(100vh-188px)] sm:h-[calc(100vh-204px)]" style="display: none;">
                    <div class="w-full flex flex-col flex-1 rounded-lg overflow-y-auto h-[calc(100vh-188px)] sm:h-[calc(100vh-204px)]">
                      <div>
                        <button type="button" class="xl:hidden hover:text-primary duration-300" @click="isShowChatMenu = !isShowChatMenu">
                          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 rounded-lg p-5 space-y-4">
                        ...
                        <form class="mt-[30px] grid grid-cols-1 sm:grid-cols-2 gap-5">
                          <input type="password" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="New Password" required="">
                          <input type="password" class="form-input rounded-[10px] h-14 placeholder:text-dark dark:placeholder:text-white" placeholder="Confirm Password" required="">
                      ...
                      <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 rounded-lg p-5 mt-5">
                        ...
                        <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 rounded-lg mt-[30px]">
