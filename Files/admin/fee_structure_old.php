      ...
      <table class="table table-bordered">
        ...
        ?>
          <tr align="center">
            ...
            <!--<td><img src="product_images/<?php // echo $pro_image; 
                                              ?>" width="60" height="60"  /></td>
<td><?php //echo $pro_price; 
    ?> </td>
...
<td><a href = "delete_pro.php?delete_pro=<?php //echo $pro_id;
      ...
      <div class="col-md-2 col-md-offset-5">
        <a href="ugfee_edit.php" class="btn btn-primary" role="button">Update Fees</a>
      </div>
      <br>
      <br>
...
<td><a href = "delete_pro.php?delete_pro=<?php //echo $pro_id;
      ...
      <div class="col-md-2 col-md-offset-5">
        <a href="phdfee_edit.php" class="btn btn-primary" role="button">Update Fees</a>
      </div>
...
<td><a href = "delete_pro.php?delete_pro=<?php //echo $pro_id;
      ...
      <div class="col-md-2 col-md-offset-5">
        <a href="mtfee_edit.php" class="btn btn-primary" role="button">Update Fees</a>
      </div>
    </div>
