...
if (isset($_SESSION['user_email'])) {
    ...
    $usql = mysqli_query($con, "SELECT * FROM student WHERE student_email = '$email'");
    $studentdata = mysqli_fetch_array($usql);
}
?>
            ...
            <button type="button" class="flex items-center gap-2.5" @click="toggle()">
                <div class="text-start">
                    <div class="flex items-center gap-1">
                        <span class="hidden xl:block text-sm font-semibold"><?= $studentdata['student_name'] ?></span>
                    ...
                    <span class="hidden xl:block text-xs text-lightgray">Student</span>
                </div>
            </button>
