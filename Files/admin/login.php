...
?>
            ...
            <div class="relative">
                ...
                <div class="min-h-[calc(100vh-192px)] p-7 flex justify-center items-center">
                    <div class="sm:p-[60px] p-9 border-2 border-gray/10 dark:border-gray/20 bg-white/10 dark:bg-white/[0.02] backdrop-blur-3xl max-w-[620px] mx-auto rounded-lg w-full">
                        ...
                        <form method="post" class="mt-[60px] space-y-5">
                            <div class="relative">
                            ...
                            <div class="!mt-[50px]">
                                <button type="submit" name="login" class="btn bg-primary py-6 uppercase tracking-widest font-bold text-sm rounded-[10px] text-white w-full hover:bg-primary/90 duration-300">
                                    Sign In
                                </button>
                            </div>
                        </form>
                ...
                <footer class="py-7 px-3 text-center">
                    <p class="font-semibold">
                       ...
                       DMS's Mandal's Collage of computer Applications
                    </p>
                </footer>
            </div>
            <!-- End Content -->
    ...
    <!-- Mirrored from dashhub-tail.netlify.app/login by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Jul 2024 16:17:05 GMT -->
    ...
    if (isset($_POST['login'])) {
        ...
        if ($get_user == "Admin") {
            ...
            if ($check_user == 0) {
                ...
                echo '<META  HTTP-EQUIV="Refresh" Content = "0.00001 ; URL = index.php">';
